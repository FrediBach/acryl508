...
- MYND speaker cases with ten acrylic sheets, optional slim front/rear damping gaskets, CAD-derived driver positions, two passive radiators, adjustable dot grilles, matching spaced rear panels with SVG/text cutouts, donor-electronics references and JSON/SVG exports (see [source dimensions and prototype limitations](docs/mynd-speaker.md))
