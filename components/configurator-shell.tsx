...
import { artFabrication, caseFabrication, panelFabrication, protectorFabrication, standFabrication } from "@/lib/fabrication";
...
export function ConfiguratorShell() {
  ...
  const { case: config, stand: standConfig, panel: panelConfig, protector: protectorConfig, art: artConfig } = history.present;
  ...
  const fabrication = useMemo(() => mode === "art" ? artFabrication(art) : mode === "case" ? caseFabrication(config, panels) : mode === "panel" ? panelFabrication(panel) : mode === "stand" ? standFabrication(stand, standError, standBusy) : protectorFabrication(protector, protectorError, protectorBusy), [mode, art, config, panels, panel, stand, standError, standBusy, protector, protectorError, protectorBusy]);
