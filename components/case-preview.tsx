...
import { caseDimensions, handleDimensions, panelTint, rackEnvelope, rackRowLayout, sidePanelMargin, type AcrylicTint, type CaseConfiguration } from "@/lib/configurator";
